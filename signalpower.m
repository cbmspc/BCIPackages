% Calculates the power of a time series signal at a particular frequency
% range (or all range if not specified)

function P = signalpower (signal, Fs, frange)
