% function A = feature_extraction(MfeatureSpace, BinData, Memship)
%
% Sphere first before feeding into this function. Otherwise it will be
% very slow!

function Fmat = featureextraction(MfeatureSpace, BinData, Memship, IDAswitch)
%
Aida = [];
mu_ida = [];
Alda = [];
