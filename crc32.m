function ret = crc32(str)
% The same as the CRC32 used in ZIP/RAR.
% Original: http://www.cs.washington.edu/homes/dhalperi/useful.html

bits = (logical(de2bi(uint32(str),8))).';
...
ret = fliplr(dec2hex(bi2de(reshape((ret),4,[]).'))');
